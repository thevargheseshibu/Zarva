...
// Test the worker job endpoint to see if end OTP is generated
async function testWorkerJob15() {
  try {
    ...
    console.log('Testing /api/worker/jobs/15 endpoint...');
        ...
        try {
          ...
          if (res.statusCode === 200 && parsed.job) {
            ...
            if (job.status === 'pending_completion' && !job.end_otp) {
              ...
              console.log('✅ Job has end OTP for worker');
            } else {
